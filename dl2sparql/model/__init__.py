...
from dl2sparql.vocab import OWLRDFVocabulary, XSDVocabulary, OWLFacet
from dl2sparql._utils import MOVE
from dl2sparql.model._base import OWLObject, OWLAnnotationObject, OWLAnnotationSubject, OWLAnnotationValue
from dl2sparql.model._iri import HasIRI, IRI
...
class OWLAnonymousClassExpression(OWLClassExpression, metaclass=ABCMeta):
    ...
    def get_nnf(self) -> 'OWLClassExpression':
        # documented in parent
        from dl2sparql.util import NNF
