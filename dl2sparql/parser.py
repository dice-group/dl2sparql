...
from dl2sparql.io import OWLObjectParser
from dl2sparql.model import OWLObjectHasSelf, OWLObjectIntersectionOf, OWLObjectMinCardinality, OWLObjectOneOf, \
...
from dl2sparql.render import _DL_SYNTAX, _MAN_SYNTAX
