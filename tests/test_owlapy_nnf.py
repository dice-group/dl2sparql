...
from dl2sparql.model import OWLObjectProperty, OWLNamedIndividual, OWLObjectComplementOf, \
...
from dl2sparql.model.providers import OWLDatatypeMinMaxExclusiveRestriction
